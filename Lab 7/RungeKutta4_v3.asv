...
function [t,r] = RungeKutta4_v3(f,r0,E0,V0,t0,tf,dt)
...
for i=1:length(t)-1
    k1 = f(t(i), r(:,i),E0,V0); % Slopes at each time step
    k2 = f(t(i)+0.5*dt, r(:,i)+0.5*dt*k1,E0,V0);
    k3 = f(t(i)+0.5*dt, r(:,i)+0.5*dt*k2,E0,V0);
    k4 = f(t(i)+dt, r(:,i)+dt.*k3,E0,V0);
